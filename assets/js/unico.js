...
var precio = document.getElementById('preciolib');
...
const Clickbutton = document.querySelectorAll('#btnAgregarCarro')
...
var btn_carro = document.getElementById('id_carro');
var ibtn_compra = document.getElementById('id_AgregarCarro');

var contador = 0;

ibtn_compra.onclick = function(){
    contador++;
    btn_carro.textContent = contador;
}
